...
const PAGE_META = {
  "/admin/dashboard": {
    title: "Dashboard",
    icon: "dashboard",
    desc: "System overview & real-time metrics",
  },
  "/admin/dispatch": {
    title: "Live Dispatch",
    icon: "emergency",
    desc: "Real-time incident management",
  },
  "/admin/tracking": {
    title: "Unit Tracking",
    icon: "location_on",
    desc: "Live GPS monitoring",
  },
  "/admin/incidents": {
    title: "Incident Logs",
    icon: "assignment",
    desc: "Historical incident records",
  },
  "/admin/personnel": {
    title: "Personnel",
    icon: "groups",
...
const SEARCH_INDEX = [
  ...
  {
    label: "Incident Logs",
    desc: "View past incidents",
    icon: "assignment",
    to: "/admin/incidents",
  },
  {
    label: "Personnel",
    desc: "Staff list & profiles",
    icon: "groups",
    to: "/admin/personnel",
  },
  {
...
const INITIAL_NOTIFS = [
  {
    ...
    title: "Critical incident — Q.1",
    body: "Cardiac arrest · AMB-07 dispatched",
    time: "2 min ago",
    read: false,
  },
  {
    ...
    title: "AMB-12 arrived on scene",
    body: "Incident EMS-1103 · Q.1",
    time: "8 min ago",
    read: false,
  },
  {
    ...
    body: "1.4 GB archived successfully",
    time: "15 min ago",
    read: false,
  },
  {
    ...
    body: "Node-Alpha: 118 ms — auto-scaling",
    time: "32 min ago",
    read: true,
  },
  {
    ...
    body: "Nguyễn Thị Bích — Role: Driver",
    time: "1h ago",
    read: true,
  },
];
  ...
  if (results.length === 0)
    return (
      <div className="absolute top-full left-0 mt-2 w-80 bg-slate-900 rounded-2xl shadow-xl border border-slate-800 z-50 p-4 text-center">
        <span className="material-symbols-outlined text-slate-600 text-[36px] block mb-1">
          search_off
        </span>
      ...
      <div className="pb-2">
        {results.map((r) => (
          ...
          >
            ...
            <span className="material-symbols-outlined text-slate-600 text-[16px] ml-auto flex-shrink-0">
              arrow_forward
            </span>
          </button>
        ))}
  ...
  <div className="absolute right-0 top-full mt-2 w-96 bg-slate-900 rounded-2xl shadow-xl border border-slate-800 z-50 overflow-hidden">
    ...
    <div className="divide-y divide-slate-800 max-h-80 overflow-y-auto">
      {notifs.map((n) => (
        ...
        >
          <div
            className={`w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5 ${n.color}`}
          >
            <span
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between gap-2">
              <p
                className={`text-[13px] font-semibold truncate ${!n.read ? "text-white" : "text-slate-400"}`}
              >
                {n.title}
              </p>
              {!n.read && (
  ...
  return (
    <div className="absolute right-0 top-full mt-2 w-64 bg-slate-900 rounded-2xl shadow-xl border border-slate-800 z-50 overflow-hidden">
      ...
      <div className="border-t border-slate-800 py-2">
        ...
        >
          <span className="material-symbols-outlined text-slate-500 group-hover:text-red-400 text-[18px] transition-colors">
            logout
          </span>
          <span className="text-[13px] text-slate-300 group-hover:text-red-400 font-medium transition-colors">
            Sign Out
          </span>
        </button>
      </div>
    ...
    <header className="h-16 z-40 bg-slate-900/95 backdrop-blur-md border-b border-slate-800 shadow-sm flex justify-between items-center px-4 sm:px-6 w-full flex-shrink-0">
      ...
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="min-w-0">
            ...
            {pageMeta.desc && (
              <p className="text-[10px] text-slate-500 hidden lg:block truncate">
                {pageMeta.desc}
              </p>
            )}
          </div>
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        ...
        <div ref={searchRef} className="relative hidden sm:block">
          ...
          >
            <span className="material-symbols-outlined text-slate-500 text-[17px] flex-shrink-0">
              search
            </span>
            <input
              type="text"
        ...
        <div ref={userRef} className="relative">
          ...
          >
            ...
            <span
              className={`material-symbols-outlined text-slate-500 text-[18px] hidden lg:block transition-transform ${userMenuOpen ? "rotate-180" : ""}`}
            >
              expand_more
            </span>
          </button>
