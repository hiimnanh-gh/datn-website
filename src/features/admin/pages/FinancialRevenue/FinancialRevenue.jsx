      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-4">
        ...
        <div className="col-span-2 sm:col-span-1 bg-gradient-to-br from-emerald-950/40 via-slate-900 to-slate-900 border border-emerald-500/30 rounded-2xl p-3.5 sm:p-4.5 space-y-1.5 sm:space-y-2 shadow-xl relative overflow-hidden">
          <div className="flex items-center justify-between">
            <span className="text-[11px] sm:text-xs font-bold text-emerald-400 font-mono uppercase tracking-wider">Doanh thu Sàn</span>
        ...
        <div className="bg-slate-900 border border-slate-800/80 rounded-2xl p-3.5 sm:p-4.5 space-y-1.5 sm:space-y-2 shadow-lg">
          <div className="flex items-center justify-between">
            <span className="text-[11px] sm:text-xs font-medium text-slate-400 font-mono uppercase">Nhiệm vụ Điều xe</span>
        ...
        <div className="bg-slate-900 border border-slate-800/80 rounded-2xl p-3.5 sm:p-4.5 space-y-1.5 sm:space-y-2 shadow-lg">
          <div className="flex items-center justify-between">
            <span className="text-[11px] sm:text-xs font-medium text-amber-400 font-mono uppercase">Chờ thanh toán</span>
        ...
        <div className="bg-slate-900 border border-slate-800/80 rounded-2xl p-3.5 sm:p-4.5 space-y-1.5 sm:space-y-2 shadow-lg">
          <div className="flex items-center justify-between">
            <span className="text-[11px] sm:text-xs font-medium text-blue-400 font-mono uppercase">Đã thanh toán</span>
                  ...
                  return (
                    <div key={idx} className="p-3.5 space-y-2.5 hover:bg-slate-800/30 transition-colors">
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          <div className="font-bold text-slate-100 text-sm">{p.providerName}</div>
                          <div className="text-slate-500 text-[11px] font-mono">ID: {p.providerId}</div>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs bg-slate-950/60 p-2.5 rounded-xl border border-slate-800/60 font-mono">
                        <div>
                          <span className="text-slate-500 text-[10px] block">Tổng điều phối:</span>
                          <span className="text-slate-200 font-bold text-sm">{p.missions}</span>
                        </div>
                        <div>
                          <span className="text-slate-500 text-[10px] block">Hoàn tất:</span>
                          <span className="text-emerald-400 font-bold text-sm">{p.completed}</span>
                        </div>
                      </div>
                    </div>
                  );
                ...
                filteredTransactions.map((tx, idx) => {
                  ...
                  return (
                    <div key={idx} className="p-3.5 space-y-2.5 hover:bg-slate-800/30 transition-colors">
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          <div className="text-emerald-400 font-bold text-xs font-mono">{tx.transactionId ? `TX-${tx.transactionId}` : 'N/A'}</div>
                          {tx.missionId && <div className="text-slate-500 text-[10px] font-mono">MIS-{tx.missionId}</div>}
                        </div>
                      ...
                      <div className="flex items-center justify-between text-xs">
                        <div>
                          <span className="font-semibold text-slate-200 block">{tx.resourceCode}</span>
                          <span className="text-slate-400 text-[11px]">{tx.driver}</span>
                        </div>
                        <div className="text-right">
                          <span className="text-slate-400 text-[10px] block">Tổng tiền:</span>
                      ...
                      <div className="flex items-center justify-between pt-1 border-t border-slate-800/60 text-xs">
                        <div className="text-[10px] font-mono text-slate-400">
                          Hoa hồng: <strong className="text-emerald-400">{tx.commission != null ? formatVND(tx.commission) : 'N/A'}</strong>
                        </div>
                        <button
